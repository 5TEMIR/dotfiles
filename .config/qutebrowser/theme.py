...
c.colors.hints.match.fg = fg_match_hint
...
c.colors.statusbar.insert.bg = bg_statusline
c.colors.statusbar.passthrough.fg = blue
c.colors.statusbar.passthrough.bg = bg_statusline
c.colors.statusbar.private.fg = purple
c.colors.statusbar.private.bg = bg_statusline
c.colors.statusbar.command.fg = fg
c.colors.statusbar.command.bg = bg_statusline
c.colors.statusbar.command.private.fg = purple
c.colors.statusbar.command.private.bg = bg_statusline
c.colors.statusbar.caret.fg = magenta
c.colors.statusbar.caret.bg = bg_statusline
c.colors.statusbar.caret.selection.fg = cyan
c.colors.statusbar.caret.selection.bg = bg_statusline
...
c.colors.tabs.selected.even.bg = "rgb(26, 27, 38)"
c.colors.tabs.selected.odd.bg = "rgb(26, 27, 38)"
