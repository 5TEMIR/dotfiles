# Generated by Powerlevel10k configuration wizard on 2026-01-04 at 15:12 +04.
...
# disconnected, left frame, blue-ornaments, sparse, few icons, concise,
...
() {
  ...
  typeset -g POWERLEVEL9K_RULER_FOREGROUND=6
